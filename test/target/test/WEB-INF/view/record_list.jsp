...
<body>
<table class="easyui-datagrid" id="record_dg">
    <thead>
    <tr>
        <th data-options="width:100,field:'id'">ID</th>
        <th data-options="width:100,field:'status',formatter:function(value){
            return value.replace('未还','<span style=\'color:red\'>未还</span>')
        }">状态</th>
...
<!-- 条件查询栏 -->
<div style="padding-top: 5px; " id="record_tb">
    <span>图书名称：
    ...
    <a href="#" class="easyui-linkbutton" iconCls="icon-search" plain="true" data-options="onClick: function () {
        ...
        $.post('record/search',{bookName:book_name,readerName:reader_name},function(data) {
          if (data==null&&data==''){
